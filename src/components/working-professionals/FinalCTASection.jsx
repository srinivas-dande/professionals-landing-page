        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.9fr] gap-12 items-start">
          ...
          <div className="lg:pl-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a1a1a] leading-tight mb-6">
              <span className="text-[#CF2030]">Your experience </span>built the career you have. Now let it build the <br />next one.
              
            </h2>
            
            <p className="text-[#6B7280] text-base mb-8 leading-relaxed">
              Every professional in our testimonials had exactly the hesitation you have now. The question isn't whether you're capable of making this switch. It's whether you act while the window is open or wait until the gap is harder to close.
            </p>
