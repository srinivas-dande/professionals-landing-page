        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-white rounded-2xl p-6 md:p-8 border border-[#E5E7EB]">
            ...
            <p className="mt-8 text-sm text-[#6B7280] leading-relaxed">
              <span className="font-bold text-[#111827]">Total Commitment: ~16 Hours Per Week.</span><br/>This schedule is specifically designed for working professionals, allowing you to build AI/ML skills without disrupting your work commitments.
            </p>
          </div>
        </div>
      </div>
