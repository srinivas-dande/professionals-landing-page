...
export async function POST(request) {
  try {
    ...
    const lead = await prisma.professionalsGoogleLead.create({
      data: {
    ...
    try {
      const webhookRes = await fetch("https://connect.pabbly.com/webhook-listener/webhook/IjU3NjIwNTY0MDYzMTA0MzA1MjZkNTUzZCI_3D_pc/IjU3NjcwNTZlMDYzMDA0MzA1MjZjNTUzNjUxMzQi_pc", {
        ...
        body: JSON.stringify({
          ...
          form_type: body.form_type || "WP - Landing Page",
          lead_stage: "New Lead",
        ...
        <div style="font-family: Arial, sans-serif; background:#f5f7fa; padding:30px;">
          <div style="max-width:520px; margin:auto; background:#ffffff; border-radius:8px; padding:25px; box-shadow:0 2px 8px rgba(0,0,0,0.05);">
            ...
            <table style="width:100%; border-collapse:collapse; font-size:14px;">
              ...
              <tr>
                <td style="padding:8px; font-weight:bold;">Current Role</td>
                <td style="padding:8px;">${body.current_role}</td>
              </tr>
